...
* Project proposal: April 18
* Project methods: May 13
* Project presentations: June 3 & 5 (during class and lab time)
* Final paper: June 6
* Peer review: June 13
...
**Due no later than 11:59pm PDT on Friday, April 18**

Write a 1-2 page description of your project idea that includes

* the question(s) of interest
* the data you will use
  - How much data do you have (time points)
  - What do the data look like (binned?, lots of missing values?, etc.)
  - Show some preliminary plots
* your general approach to analyzing the data
* a draft introduction section for your project (2-3 paragraphs).
...
**Due no later than 11:59pm PDT on Friday, May 9**
...
**Due no later than 11:59pm PDT on Friday, June 6**
...
**Due no later than 11:59pm PDT on Friday, June 13**
