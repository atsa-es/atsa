...
knitr::include_graphics("https://atsa-es.github.io/atsa/Lectures/Week%207/images/superbowl.png")
```
...
knitr::include_graphics("https://atsa-es.github.io/atsa/Lectures/Week%207/images/forecastsalmon.png")
```

## Covariates -> Forecast

```{r out.width=c('300px', '350px'), out.extra='style="float:left; display:block; padding:30px"', echo=FALSE}
knitr::include_graphics("https://atsa-es.github.io/atsa/Lectures/Week%207/images/salmoncovariates.jpg")
knitr::include_graphics("https://atsa-es.github.io/atsa/Lectures/Week%207/images/redgreenyellowlight.png")
```
