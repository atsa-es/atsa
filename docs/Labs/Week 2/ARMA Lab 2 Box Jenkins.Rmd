...
Load catch landings from Greek waters [landings.Rdata](Labs/Week 2/landings.Rdata) and the Chinook landings  [chinook.Rdata](Labs/Week 2/chinook.Rdata) in Washington data.  
