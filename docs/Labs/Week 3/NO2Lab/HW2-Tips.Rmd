...
For this analysis, you will use MARSS models and you can follow/copy [chapter 7 in the lab manual](https://nwfsc-timeseries.github.io/atsa-labs/chap-mss.html).
...
\begin{bmatrix}v_1\\v_2\end{bmatrix} ~ \text{MVN}(0,\mathbf{R})
$$
$$
...
The lectures tab on the course website has a link to a [MARSS reference sheet](https://nwfsc-timeseries.github.io/atsa/Lectures/Week%203/MARSS_Reference_Sheet.pdf). Use that to help you when you set up your models.
...
For part 2, you'll use the material in chapter 8, [section 8.6](https://nwfsc-timeseries.github.io/atsa-labs/sec-msscov-season.html) in the lab manual.
