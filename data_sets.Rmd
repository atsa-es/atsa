...
* [Mean daily streamflow](https://noaa-nwfsc.github.io/Streamflow-Means-NWM/) for all west coast rivers 1979-2023.
* Some tutorials for processing climate data
  - [NASA Earthdata Cookbook](https://nasa-openscapes.github.io/earthdata-cloud-cookbook/)
  - [PACE data tutorials](https://oceancolor.gsfc.nasa.gov/resources/docs/tutorials/)
  - [CoastWatch tutorials](https://github.com/coastwatch-training/CoastWatch-Tutorials)
  - [IOOS CodeLab](https://ioos.github.io/ioos_code_lab/content/intro.html)
  - [NOAA HackHours 2025](https://nmfs-opensci.github.io/NMFSHackDays-2025/)
