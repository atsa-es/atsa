...
uni_ss <- list(
  ...
  youtube = "",
  reading = c("[HWSb: Chap 6](https://atsa-es.github.io/atsa-labs/chap-univariate-state-space.html)", "Additional background resources",
...
marss_covariates <- list(
  ...
  youtube = "",
  reading = c("[lec_07_covariates.R](Lectures/Week 4/lec_07_covariates.R)",
...
dlm <- list(
  ...
  video = "[2021 Video](https://youtu.be/Uxx2jK7heNE)",
  youtube = "",
...
HMMs <- list(
  ...
  video = "[2021 Video](https://youtu.be/CqmAs3aPf_k)",
  youtube = "",
  reading = c("[Zucchini et al. 2006](https://www.researchgate.net/profile/Jan_Bulla/publication/256503512_Hidden_Markov_Models/links/0c9605232dce693fa3000000/Hidden-Markov-Models.pdf)", "[hmmTMB vignette](https://github.com/TheoMichelot/hmmTMB)"),
  instructor = "Eric"
)
```
...
freqdomain <- list(
  ...
  video = "",
  youtube = "",
  reading = "",# c("[2021 Video](https://youtu.be/XCnHQve-Tmk)", "[Graps (1995)](https://www.eecis.udel.edu/~amer/CISC651/IEEEwavelet.pdf)", "[Percival & Walden (2000)](https://staff.washington.edu/dbp/wmtsa.html)"),
  instructor = "Mark"
)
```
...
spatial <- list(
  ...
  video = "[2025 Video](https://youtu.be/RrOjcSbBEg0)",
  youtube = "",
...
present1 <- list(
  ...
  topics = c("Student presentations", "Order: Ben, Nicole, Matheus"),
  pdf = "",
  ppt = "",
  rmd = "",
  html = "",
...
present2 <- list(
  title = "Student presentations",
  topics = c("Student presentations", "Order: Brian, Tina, Emma, Mary, Lilac, Anna"),
  pdf = "",
  ppt = "",
  rmd = "",
  html = "",
