...
HMMs <- list(
  ...
  pdf = "",
  ppt = "",
  rmd = c("Lectures/Week 6/lec_11_hmm.Rmd", "Lectures/Week 6/lec_11_hmm_inclass.Rmd"),
  html = "",# "Lectures/Week 5/lec_10_hmm.html",
  video = "",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/CqmAs3aPf_k)", "[Zucchini et al. 2006](https://www.researchgate.net/profile/Jan_Bulla/publication/256503512_Hidden_Markov_Models/links/0c9605232dce693fa3000000/Hidden-Markov-Models.pdf)", "[depmixS4 vignette](https://cran.r-project.org/web/packages/depmixS4/vignettes/depmixS4.pdf)"),
  instructor = "Eric"
)
```
...
GAMs <- list(
  ...
  pdf = "",
  ppt = "",
  rmd = c("Lectures/Week 5/lec_10_intro_to_GAMs.Rmd"),
  html = "",# "Lectures/Week 5/lec_10_hmm.html",
  video = "",
  youtube = "",
  reading = "",
...
GAMs2 <- list(
  ...
  pdf = "",
  ppt = "",
  rmd = c("Lectures/Week 6/lec_12_multivariate_GAMs.Rmd"),
  html = "",# "Lectures/Week 5/lec_10_hmm.html",
  video = "",
  youtube = "",
  reading = "",
