...
forecast <- list(
  ...
  pdf = c("Lectures/Week 2/lec_04_Intro_ARIMA.pdf", "Lectures/Week 2/lec_04_Fitting_and_Selecting_ARMA_models.pdf", "Lectures/Week 2/lec_04_Forecasting_ARIMA.pdf"),
  ppt = "",
  rmd = "",
  html = c(Intro="Lectures/Week 2/lec_04_Intro_ARIMA.html", Fitting="Lectures/Week 2/lec_04_Fitting_and_Selecting_ARMA_models.html", Forecasting="Lectures/Week 2/lec_04_Forecasting_ARIMA.html"),
  video = c("https://youtu.be/ML1l4Zk_5Vo", "https://youtu.be/HOVDmx_juMk"),
  youtube = "",
  reading = c("[HA18: Chap 8.6-8.9](https://otexts.org/fpp2/arima.html)","[H18: ARIMA Models](https://fish-forecast.github.io/Fish-Forecast-Bookdown/3-arima-models.html)", "[CM09: Chap 7.1-7.2](Files/Introductory_Time_Series_With_R.pdf)", "CM not as useful this week"),
  instructor = "Eli"
)
```
...
uni_ss <- list(
  ...
  reading = c("[HWS18a: Chap 7](https://cran.r-project.org/web/packages/MARSS/vignettes/UserGuide.pdf)",
              "[HWSb: Chap 6](https://atsa-es.github.io/atsa-labs/chap-univariate-state-space.html)",
              ...
              "[uni_example_4.R](Lectures/Week 3/univariate_example_4.R)", "[Auger-Méthé et al 2021](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecm.1470)"),
  instructor = "Eli"
)
```
