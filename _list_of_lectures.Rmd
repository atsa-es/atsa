...
forecast <- list(
  ...
  topics = c("Box-Jenkins method", "Forecasting with ARIMA models", "Seasonal ARIMA models", "Exponential Smoothing Models"),
  pdf = c(""),
  ppt = "",
  rmd = c(""),
  html = c(""),
  video = c(""),
  youtube = "",
  reading = c("[HA18: Chap 8.6-8.9](https://otexts.org/fpp2/arima.html)", "[HA18: Chap 7](https://otexts.com/fpp2/expsmooth.html)", "[H18: ARIMA Models](https://fish-forecast.github.io/Fish-Forecast-Bookdown/3-arima-models.html)", "[CM09: Chap 7.1-7.2](Files/Introductory_Time_Series_With_R.pdf)"),
  instructor = "Eli"
)
```
```{r eval=FALSE}
...
uni_ss <- list(
  ...
  topics = c("Linear Gaussian state space models", "Kalman filter", "Random walks"),
  pdf = c(""),
  ppt = "",
  rmd = c(""),
  html = c(""),
