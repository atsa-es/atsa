...
intro <- list(
  ...
  video = "[2025 Video](https://youtu.be/fhGykGbTsj0)",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/XeAN-zYhqGw)", "[CM09: Chap 1](Files/Introductory_Time_Series_With_R.pdf)", "[HA18: Chap 6](https://otexts.org/fpp2/decomposition.html)","[HSW18: Intro to ts](https://atsa-es.github.io/atsa-labs/chap-ts.html)" ),
  instructor = "Mark"
)
```
...
ts_basics <- list(
  ...
  video = "[2025 Video](https://youtu.be/1HVrtNh_1Ho)",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/vwHqxe9eVMk)", "[CM09: Chap 2](Files/Introductory_Time_Series_With_R.pdf)","[CM09: Chap 4](Files/Introductory_Time_Series_With_R.pdf)","[HA18: Chap 8.1](https://otexts.org/fpp2/stationarity.html)","[HSW18: Intro to ts](https://atsa-es.github.io/atsa-labs/chap-ts.html)", "[R script for class](lec_02_covariance_stationarity.R)"),
  instructor = "Mark"
)
```
...
arma_basics <- list(
  ...
  video = "[2025 Video](https://youtu.be/-f3mepdywUQ)",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/IgX9Bpu3ggc)", "[CM09: Chap 6](Files/Introductory_Time_Series_With_R.pdf)","[CM09: Chap 7](Files/Introductory_Time_Series_With_R.pdf)","[HA18: Chap 8.1-8.5](https://otexts.org/fpp2/arima.html)", "[R script for class](https://atsa-es.github.io/atsa/Lectures/Week%202/lec_03_ARMA_models.R)"),
  instructor = "Mark"
)
```

```{r classic-forecasting}
# 2025
forecast <- list(
  title = "Classic TS Forecasting",
  topics = c("Box-Jenkins method", "Forecasting with ARIMA models", "Seasonal ARIMA models"),
  pdf = c("Lectures/Week 2/lec_04_Fitting_ARMA.pdf", "Lectures/Week 2/lec_04_Forecasting_ARIMA.pdf"),
  ppt = "",
...
```{r uni-ss}
uni_ss <- list(
  title = "More classic TS forecasting + Univariate state-space models",
  topics = c("Holt and Holt-Winters", "Model performance", "Linear Gaussian state space models", "Random walks"),
  pdf = c("Lectures/Week 3/lec_05_holt.pdf", "Lectures/Week 3/lec_05_uni.pdf"),
  ppt = "",
  rmd = c("Lectures/Week 3/lec_05_holt.Rmd", "Lectures/Week 3/lec_05_uni.Rmd"),
  html = c("Lectures/Week 3/lec_05_holt.html", "Lectures/Week 3/lec_05_uni.html"),
  video = "[2025 Video](https://youtu.be/HONpDq4McX8)",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/-G_ejXMzEWw)", "[HWSb: Chap 6](https://atsa-es.github.io/atsa-labs/chap-univariate-state-space.html)", "Additional background resources",
"[HWS18a: Chap 7](https://cran.r-project.org/web/packages/MARSS/vignettes/UserGuide.pdf)", "[MARSS function](Lectures/Week 3/MARSS_function.html)","[MARSS Ref Sheet](Lectures/Week 3/MARSS_Reference_Sheet.pdf)", "[Auger-Méthé et al 2021](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecm.1470)", "Scripts are in the class repo"),
  instructor = "Eli"
)
```
```{r eval=FALSE}
...
marss <- list(
  ...
  topics = c("Introduction to multivariate state-space models", "Multivariate random walks"),
  pdf = c("Lectures/Week 3/lec_06_marss.pdf"),
  ppt = "",
  rmd = c(""),
  html = c(""),
  video = "[2025 Video](https://youtu.be/uoLm66v5P3c)", 
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/4nrZZGMY1bc)", "[HWS18a: Chap 8](https://cran.r-project.org/web/packages/MARSS/vignettes/UserGuide.pdf)",
              "[MARSS function](Lectures/Week 3/MARSS_function.html)",
              "[MARSS Ref Sheet](Lectures/Week 3/MARSS_Reference_Sheet.pdf)",
              "[example scripts in repo](https://github.com/atsa-es/fish550-2025/tree/main/Lectures%20Week%203)"),
  instructor = "Eli"
)
```
```{r eval=FALSE}
...
marss_covariates <- list(
  ...
  video = "[2025 Video](https://youtu.be/lalHo5xRETw)",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/2Jb5pzgtuH0)", 
  "[lec_07_covariates.R](Lectures/Week 4/lec_07_covariates.R)",
    ...
    "[H18: Chap 6](https://fish-forecast.github.io/Fish-Forecast-Bookdown/6-1-multivariate-linear-regression.html)", "[example scripts in repo](https://github.com/atsa-es/fish550-2025/tree/main/Lectures%20Week%204)"),
  instructor = "Eli"
)
```
...
dfa <- list(
  ...
  video = "[2025 Video](https://youtu.be/0S13ySyr4Mc)",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/LVlo8I0PdPA)", "[Zuur et al. 2003a](http://www.nrcresearchpress.com/doi/abs/10.1139/f03-030#.XFyd_xJ7l9M)", "[Zuur et al. 2003b](https://onlinelibrary.wiley.com/doi/abs/10.1002/env.611)", "[Ohlberger et al. 2016](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecs2.1333)", "[HWS18a: Chap 10](https://cran.r-project.org/web/packages/MARSS/vignettes/UserGuide.pdf)"),
  instructor = "Mark"
)
```
...
dlm <- list(
  ...
  video = "NA",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/Uxx2jK7heNE)", "[Petris et al. (2009)](Files/Petris_2009_DLMs_in_R.pdf)", "[HWS18a: Chap 16](https://cran.r-project.org/web/packages/MARSS/vignettes/UserGuide.pdf)", "[Scheuerell & Williams (2005)](Files/Scheuerell_2005_forecasting_SARs.pdf)"),
  instructor = "Mark"
)
```
...
HMMs <- list(
  ...
  pdf = "",
  ppt = "",
  rmd = c("Lectures/Week 5/lec_10_hmm.Rmd", "Lectures/Week 6/lec_10_hmm_inclass.Rmd"),
  html = "Lectures/Week 5/lec_10_hmm.html",
  video = "NA",
  youtube = "",
  reading = c("[2021 Video](https://youtu.be/CqmAs3aPf_k)", "[Zucchini et al. 2006](https://www.researchgate.net/profile/Jan_Bulla/publication/256503512_Hidden_Markov_Models/links/0c9605232dce693fa3000000/Hidden-Markov-Models.pdf)", "[hmmTMB vignette](https://github.com/TheoMichelot/hmmTMB)"),
  instructor = "Eric"
)
```
...
GAMs <- list(
  ...
  topics = c("Generalized additive models"),
  pdf = "",
  ppt = "",
  rmd = "Lectures/Week 6/lec_11_intro_to_GAMs.Rmd",
  html = "Lectures/Week 6/lec_11_intro_to_GAMs.html",
  video = "[2025 Video](https://youtu.be/DajMTeoGchU)",
  youtube = "",
  reading = "",
  instructor = "Eric"
)
...
```{r}
GAMs2 <- list(
  title = "Multivariate GAMs",
  topics = c("Multivariate GAMs"),
  pdf = "",
  ppt = "",
  rmd = "Lectures/Week 6/lec_12_multivariate_GAMs.Rmd",
  html = "Lectures/Week 6/lec_12_multivariate_GAMs.html",
  video = "[2025 Video(https://youtu.be/RRminZlov9A)",
  youtube = "",
  reading = c("[Clark and Wells 2022](https://doi.org/10.1111/2041-210X.13974)", "[mvgam](https://nicholasjclark.github.io/mvgam/)"),
  instructor = "Eric"
)
```
...
model_inf <- list(
  ...
  video = "[2025 Video](https://youtu.be/rrkPSO0C4Fc)",
  youtube = "",
...
spatial <- list(
  ...
  pdf = c(""),
  ppt = "",
  rmd = c("Lectures/Week 7/lec_14_sdmtmb.Rmd"),
  html = c("Lectures/Week 7/lec_14_sdmtmb.html"),
  video = "",
  youtube = "",
  reading = "https://pbs-assess.github.io/sdmTMB-teaching/noaa-psaw-2022/",
  instructor = "Eric"
)
```
...
spatial2 <- list(
  ...
  html = "",# c("Lectures/Week 9/lec_18_spatiotemporal.html", "Lectures/Week 9/lec_19_sdmtmb.html", "Lectures/Week 9/lec_19_exercise.html"),
...
interactions1 <- list(
  ...
  topics = c("MAR(p) Models", "Estimating interaction strengths",
             "Gompertz models", "Community stability metrics"),
  pdf = "",
  ppt = "",
