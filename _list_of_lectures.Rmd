...
present1 <- list(
  ...
  topics = c("Nick: Repeat spawning of steelhead", "Dylan: Analyzing mountain lion movement data", "Zoe: Model-based stoplight chart for seabird indicators", "Emma: Ocean microbiome community drivers"),
  pdf = "",
  ppt = "",
  rmd = "",
  html = "",
