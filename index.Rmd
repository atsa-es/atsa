...
subtitle: "FISH 550 &nbsp; &nbsp; University of Washington &nbsp; &nbsp; Spring Qtr 2023"
output:
  html_document:
    toc: true
    toc_float: true
...
[Textbook](https://atsa-es.github.io/atsa-labs/) Holmes, E. E., M. D. Scheuerell, and E. J. Ward. Applied Time Series Analysis for Fisheries and Environmental data. eBook. 

[YouTube Channel](https://www.youtube.com/@SAFSTimeSeries) Recorded lectures

[Class GitHub repo](https://github.com/atsa-es/fish550-2023), [Discusssion board](https://github.com/atsa-es/fish550-2023/discussions)
...
In addition to email and video, we will use the "Discussion" feature in our class **GitHub** repository to ask questions and assist others. Specifically, questions and answers can be posted to the discussion in the course repository [https://github.com/nwfsc-timeseries/safs-timeseries/issues](https://github.com/atsa-es/fish550-2023/discussions).
...
You are welcome to use these and they can be powerful coding assistants --- especially when you are not an expert in R, Stan or TMB etc. GitHub Copilot is an AI pair programmer, and is [free for students](https://docs.github.com/en/copilot/quickstart) (or you can get a 60 day trial). [What a video to learn how to use](https://www.youtube.com/watch?v=XQ4Negbmtk4). They can also be helpful for understanding material (personal AI tutor). If you use these for the lab text or paper text, please note this in your lab write-up so we can get a better understanding of how these tools help in the research process. You will not be downgraded for for using these; unless you use AI to simply generate large chunks of text! Use these tools to help you write better and faster and then go more indepth into your novel contribution.
