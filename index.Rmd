...
subtitle: "FISH 550 &nbsp; &nbsp; University of Washington &nbsp; &nbsp; Spring Qtr odd years"
output:
  html_document:
    toc: true
    toc_float: true
...
Holmes, E. E., M. D. Scheuerell, and E. J. Ward. Applied Time Series Analysis for Fisheries and Environmental data. eBook. [Available here](https://nwfsc-timeseries.github.io/atsa-labs/)
...
In addition to email and video, we will use the "Issues" feature in **GitHub** to ask questions and assist others. Specifically, questions and answers can be posted to the issues in the course repository [here](https://github.com/nwfsc-timeseries/safs-timeseries/issues).
