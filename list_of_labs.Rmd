...
sslab2 <- list(
  ...
  youtube = "",
  data = "",
  homework = "Chap 5 Univariate SS: Problems 6 and 7; Chap 6 Multivariate SS: Problems 1,2,3,4,6 (skip 5); you can do Chap 5 problems just using Chap 6 information.",
  key = "",
  instructor = "Eli",
