...
arimalab <- fill.list(
  ...
  hw_duedate = "Due Apr 18 Tues 11:59 PM PDT; Post to GitHub."
)
```
...
sslab2 <- fill.list(
  ...
  hw_duedate = "Due April 25 Tues 11:59 PM PDT; Post to GitHub"
)
```
...
dfalab <- fill.list(
  ...
  hw_duedate = "Due May 2 Tues 11:59 PM PDT; Post to GitHub"
)
```
...
hmmlab <- fill.list(
  ...
  instructor = "Eric",
  hw_topics = c(""),
  hw_duedate = "Due May 9 Thurs 11:59 PM PDT; Post to GitHub"
)
```
...
dlmlab <- fill.list(
  ...
  hw_duedate = "Due May 16 Tues 11:59 PM PDT; Post to GitHub"
)
```
