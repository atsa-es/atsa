...
matrixlab <- list(
  ...
  youtube = "",
  data = "",
  homework = "Optional (not part of grade): Listed at end of lab",
...
lmlab <- list(
  ...
  youtube = "",
  data = "",
  homework = "Optional (not part of grade): End of Linear Regression chapter",
...
forecastlab <- list(
  ...
  youtube = "",
  data = "",
  homework = "Intro to ts: problems at end of lab<br>Fitting ARMA models: problems at end of lab",
  key = "",
