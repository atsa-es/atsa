...
hmmlab <- list(
  ...
  youtube = "",
  data = "",
  homework = "HW #6: HMM/State space models w Stan. [Rmd Part 1](https://nwfsc-timeseries.github.io/atsa/Labs/HW6/HW6-part1.Rmd), [html Part 1](https://nwfsc-timeseries.github.io/atsa/Labs/HW6/HW6-part1.html)",
  key = "",
  instructor = "Eli & Eric",
  hw_topics = c(""),
