...
sslab2 <- list(
  ...
  pdf = "",
  rmd = c("https://nwfsc-timeseries.github.io/atsa/Labs/Week 3/NO2Lab/HW2_NO2.Rmd"),
  html = c("https://nwfsc-timeseries.github.io/atsa/Labs/Week 3/NO2Lab/HW2_NO2.html"),
  video = "",
  youtube = "",
  data = c("https://nwfsc-timeseries.github.io/atsa/Labs/Week 3/NO2Lab/ECNNO2.RData"),
  homework = "The questions are in the Rmd file. You can skip the OPTIONAL questions, but try to tackle all the others.",
  key = "",
  #key = c("Labs/Week 3/HW_3_uss_Key.html", "Labs/Week 3/HW_3_Key.html"),
  instructor = "Eli",
  hw_topics = c("State-space models"),
  hw_duedate = "Due next Fri 11:59 PM PST; email to Eli"
)
```
