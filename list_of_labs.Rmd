...
forecastlab <- list(
  ...
  key = c("Labs/Week 2/HW_2_ts_Key.html"),
  instructor = "Mark & Eli",
...
sslab1 <- list(
  ...
  video = "",
  data = "",
  homework = "Intro to uniSS: problems at end of chapter",
  key = "",
  instructor = "Eli",
...
sslab2 <- list(
  ...
  youtube = "",
  data = "",
  homework = "Chap 5 Univariate SS: Problems 6 and 7; Chap 6 Multivariate SS: Problems 1,2,3,4,6 (skip 5); you can do Chap 5 problem just using Chap 6 information.",
  key = "",
  instructor = "Eli",
  hw_topics = c("State-space models"),
  hw_duedate = "Due 5pm next THURS; email to instructor(s) for lab"
)
```
