...
The cross-correlation function is the CCVF normalized by standard deviations of x & y
...
The distributional form of the $w_t$ does not matter, but often we assume so-called _Gaussian white noise_, whereby
...
If $\{w_t\}$ is Gaussian white noise, then
