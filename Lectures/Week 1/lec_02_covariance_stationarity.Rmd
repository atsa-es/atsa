...
```{r station_in_mean, fig.cap="The expectation is constant across time"}
nn <- 200
tt <- 40
...
If $\text{E}(x_t)$ is constant across time, we say the time serie is _stationary_ in the mean
...
Can estimate ACF from a sample as
...
> - $r_k = r_{-k}$ (it’s an “even function”)  

> - $r_k$ of periodic function is itself periodic  

> - $r_k$ for sum of 2 indep vars is sum of $r_k$ for each  
