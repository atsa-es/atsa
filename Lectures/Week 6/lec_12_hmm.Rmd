...
Output from the model will give us the conditional distribution, $P(Y_{t}|x_{t}=i)$
...
3. Estimate / update parameters: EM-algorithm
...
Forward backward algorithm has 3 steps:
