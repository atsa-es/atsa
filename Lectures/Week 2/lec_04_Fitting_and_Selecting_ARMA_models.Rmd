...
subtitle: |
  ...
  [Download Rmd](https://atsa-es.github.io/atsa/Lectures/Week%202/lec_04_Fitting_and_Selecting_ARMA_models.Rmd)
---
...
- Many standard algorithms for fitting ARIMA models assume stationarity.  You can fit ARIMA models without this assumption, but you need to use the appropriate algorithm.
- Many processes in environmental science are fundamentally random walks, i.e. non-stationary, e.g. movement, population growth, genetic drift. One must be careful to either deal with non-stationarity via transformation  OR use an algorithm which doesn't assume stationarity.
