...
$$x_t = \mu + \beta_1 x_{t-1} + \beta_2 x_{t-2} + e_t$$
or as `Arima()` would write this model:
$$(x_t-m) = \beta_1 (x_{t-1}-m) + \beta_2 (x_{t-2}-m) + e_t$$
where $x_t$ is the first difference of our anchovy data. $\mu = m(1 - \beta_1 - \beta_2)$.
...
$$x_t = 0.1065807-0.53850433 x_{t-1} - 0.44732522 x_{t-2} + e_t$$
