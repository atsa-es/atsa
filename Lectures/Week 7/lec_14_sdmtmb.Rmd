...
```{r sim-tweedie, fig.width=4, fig.height = 3.2, out.width='400px'}
set.seed(123)
...
```{r, fig.height=4, fig.width=5, results='markup'}
knitr::include_graphics("owl-nao-effect.png")
```
...
* Vignette for residual checking
...
```{r index-demo, echo=TRUE, results = 'markup'}
