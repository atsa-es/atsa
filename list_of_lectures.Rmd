...
uni_ss <- list(
  ...
  reading = c("[HWS18a: Chap 7](https://cran.r-project.org/web/packages/MARSS/vignettes/UserGuide.pdf)",
              ...
              "[uni_example_lm.R](Lectures/Week 3/univariate_example_lm.R)",
              "[uni_example_arima.R](Lectures/Week 3/univariate_example_arima.R)"),
  instructor = "Eli"
)
```
...
dfa <- list(
  ...
  topics = c("Dynamic factor analysis (DFA), Project Proposal due Thurs 11:50 pm"),
  pdf = "",
  ppt = "",
  rmd = "",
  html = "",
