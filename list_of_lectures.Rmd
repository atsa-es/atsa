...
uni_ss_tmb <- list(
  ...
  video = "",
  youtube = "",
  reading = c("[HWSb: Chap 6](https://nwfsc-timeseries.github.io/atsa-labs/chap-univariate-state-space.html)", "[Stan manual](https://mc-stan.org/users/documentation/)", "[Auger-Méthé et al 2021](https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecm.1470)"),
  instructor = "Eli"
)
```
