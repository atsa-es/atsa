...
model_inf <- list(
  ...
  pdf = "Lectures/Week 4/lec_7_modelselection.pdf",
  ppt = "",
  rmd = "Lectures/Week 4/lec_7_modelselection.Rmd",
  html = "Lectures/Week 4/lec_7_modelselection.html",
  video = "https://youtu.be/hF4aoFBZoCU",
  reading = c(""),
