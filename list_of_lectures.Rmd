...
freqdomain <- list(
  ...
  video = "https://washington.zoom.us/rec/share/-ik7bfT6R-XIz1F2TLScfhic0LwG0rZNkS1vb9TVAHliD-dco8g3gQrUjqOh_zbr.P2tyeHsNzVkmHH2H",
  youtube = "",
...
marss_covariates <- list(
  ...
  video = "https://washington.zoom.us/rec/share/WGy5VRovHvXoxx8Gv9FREu_GBqszSDGo_ha1W1pIYjR7XK1csHGjkHvIv5_4wCkS.vpW-yoEa-VgQpcmZ",
  youtube = "",
  reading = c(
...
model_inf <- list(
  ...
  video = "https://washington.zoom.us/rec/play/zfZiW5ojU0qYgxmAecEzEfkQk6oRy96wFP0v0hMPUh-1nUnm7fT97zumEDWj1eJQCiafFC41hfn9f_08.fhVBaxZzqT99HzmX?continueMode=true",
  youtube = "",
...
dlm <- list(
  ...
  video = "https://washington.zoom.us/rec/share/7YVTi6WO_egI7eH6cy7bo5eKJ0t2h9FVGZcW1TGnVw7JTYVpOw7gNgzRQRma.LiQf8tzgZMH-_R7f",
  youtube = "",
...
bayes <- list(
  ...
  video = "https://washington.zoom.us/rec/share/_-57I0Rr8NdtUboU9RG_54MgKXAQuskB6m8NZmFHIK630O9RsgV9KioimyGj5hOd.2yB_dFMGP1X09do8",
  youtube = "",
...
bayes2 <- list(
  ...
  topics = c("MAP estimation", "Multivariate models", "DFA", "Writing our own Bayesian models in Stan"),
  pdf = "Lectures/Week 6/lec_12_bayes2.pdf",
  ppt = "",
  rmd = "Lectures/Week 6/lec_12_bayes2.Rmd",
  html = "Lectures/Week 6/lec_12_bayes2.html",
  video = "https://washington.zoom.us/rec/share/9pMPeZer8xuWiK7TAHeHvIfMdwLlhk-vj-TDEXPpbAcxHnBfOed72DpPi5faieGs.FxNfnqDsfVEd9DHc",
  youtube = "",
...
interactions1 <- list(
  ...
  video = "https://washington.zoom.us/rec/share/mVed0HQfWxXTpUVFCfBSMZfAYpbibSe0LMUZYPUTPwY4pC5_NpWKn5IGTUe9bSz4.Drn0yA6_pMok7T3q",
  youtube = "",
...
spatial <- list(
  ...
  pdf = c(""),
  ppt = "",
  rmd = c("Lectures/Week 9/lec_17_spatiotemporal.Rmd", "Lectures/Week 9/lec_17_spatiotemporal.Rmd"),
  html = c("Lectures/Week 9/lec_17_spatiotemporal.html", "Lectures/Week 9/lec_17_spatiotemporal.html"),
  video = "https://washington.zoom.us/rec/share/hV8ipY56PTwJCnmvpdpP-Hq_zWgJhp7yjWN1ebIuf6tJJb2WM3dimBjtzOyWpt2H.5P7ftS8sYMyOPIWT",
  youtube = "",
...
spatial2 <- list(
  ...
  pdf = "",
  ppt = "",
  rmd = c("Lectures/Week 9/lec_18_spatiotemporal.Rmd", "Lectures/Week 9/lec_18_spatiotemporal.Rmd"),
  html = c("Lectures/Week 9/lec_18_spatiotemporal.html", "Lectures/Week 9/lec_18_spatiotemporal.html"),
  video = "",
  youtube = "",
  reading = c(""),
  instructor = "Eric"
...
HMMs <- list(
  ...
  pdf = "Lectures/Week 5/lec_10_hmm.pdf",
  ppt = "",
  rmd = "Lectures/Week 5/lec_10_hmm.Rmd",
  html = "Lectures/Week 5/lec_10_hmm.html",
  video = "https://washington.zoom.us/rec/play/b_oZunMhqfYSYwccynu0z31YqS9MbzyIdH7BGQMRyQTGazhJhHr73Exa9InofHq1BgGbmel4iCUgHvuR.8QqLdLKjIQKlEeq0?autoplay=true&continueMode=true&startTime=1612474828000",
  youtube = "",
...
present1 <- list(
  ...
  topics = c("Gilman", "Buonanduci", "Min", "Fricke"),
  pdf = "",
  ppt = "",
  rmd = "",
  html = "",
...
present2 <- list(
  title = "Student presentations",
  topics = c( "Arnold", "Kwarta", "Diallo", "DuVall"),
  pdf = "",
  ppt = "",
  rmd = "",
  html = "",
...
EDM <- list(
  ...
  video = "https://washington.zoom.us/rec/share/8iX3w8NPmq0a2a-5pooE8JZMfzv4_aUTctCAgIn9raLjW64bijBd_oI8rjYqqcRk.d7w9XnEEiKSU2HCS",
  youtube = "",
