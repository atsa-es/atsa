...
covariates <- list(
  ...
  html = "",
  video = "",
  reading = c("[HA18: Chap 5](https://otexts.com/fpp2/regression.html)","[H18: Chap 6](https://fish-forecast.github.io/Fish-Forecast-Bookdown/6-1-multivariate-linear-regression.html)"),
  youtube = "",
  instructor = "Eli"
)
```
...
HMMs <- list(
  ...
  video = "https://youtu.be/MHJFNeK-rug",
