...
## topics formatted for html
data_links_html <- sapply(lapply(data_links, function(x){ tmp <- paste("[",x,"](",x,")<br>", collapse=""); tmp[x==""]=""}), c)
...
## topics formatted for html
key_links_html <- sapply(lapply(key_links, function(x){ tmp <- paste("[Key](",x,")<br>", collapse=""); tmp[x==""]=""}), c)
...
colnames(syl_txt) <- c("Date", "Topics", "Lab Write-up", "Data", "Video", "Homework", "Key")
## generate table
