...
For this lab you will use the material you have learned on ARMA and ETS models to explore features of time series of salmon in the North Pacific (Alaska and E Asia). Then you will use these models to create forecasts and ask a research question with those forecasts.

You will find this Rmd file in the [Fish550-2025 repository](https://github.com/atsa-es/fish550-2025/tree/main/Lab-1). Clone the repository and then make sure you can Knit the `Lab1-ARIMA.Rmd` file on your computer. Install any packages that it complains about.
