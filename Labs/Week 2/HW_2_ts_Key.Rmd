...
Here are the answers for the homework problems based on the material in [Basic time series functions in R](https://nwfsc-timeseries.github.io/atsa-labs/chap-ts-lab.html).  You can download the Rmd file for this key from [here](HW_2_ts_Key.html).
...
Our "best" model is an AR(1) model that includes a non-zero intercept. We can get the parameter values directly from the output in Question 5. So, our AR(1) model becomes:
$$
