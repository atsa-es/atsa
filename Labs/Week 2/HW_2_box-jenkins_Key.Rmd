...
```
Here are the answers for the homework problems from the second week of class based on the material in [Basic time series functions in R](https://nwfsc-timeseries.github.io/atsa-labs/chap-ts-lab.html) and [Box-Jenkins method in R](https://nwfsc-timeseries.github.io/atsa-labs/chap-labboxjenkins-.html).  
