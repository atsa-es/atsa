...
* Holmes, E. E., M. D. Scheuerell, and E. J. Ward. 2023. _Applied Time Series Analysis for Fisheries and Environmental Data_. eBook available [here](https://atsa-es.github.io/atsa-labs/). 

* Holmes, E. J. Ward., and M. D. Scheuerell. Analysis of multivariate time
series using the MARSS package. available [here](https://cran.r-project.org/web/packages/MARSS/vignettes/UserGuide.pdf)

* Previously recorded lectures on our [YouTube Channel](https://www.youtube.com/@SAFSTimeSeries) 

* FISH 550 [GitHub repo](https://github.com/atsa-es/fish550-2025)  & [Discusssion board](https://github.com/atsa-es/fish550-2025/discussions) & [Team Lab Write-ups](https://atsa-es.github.io/fish550-2025/)

* R package [{MARSS}](https://cran.r-project.org/web/packages/MARSS/index.html) MARSS: Multivariate Autoregressive State-Space Modeling
...
### Lectures 
Tuesday & Thursday from 1:30-3:00 PM in FSH 203

### Computer Lab
Thursday from 3:00-4:00 PM in FSH 203

### Office hours

Eli: Tuesday 4:30-5:30 PM in FSH 216

Eric: TBD

Mark: Thursdays from 12:00-1:00 in FSH 220A

***

# Pre-requisites

Students should have a working knowledge of the [**R**](https://www.r-project.org/) computing software, such as that provided in FISH 552/553 and FISH 549. Students should also have an understanding of basic probability and statistical inference.
...
* Please let us know if *anyone* in class says something that makes you feel uncomfortable^[If the instructor should be the one to say or do something that makes a student uncomfortable, the student should feel free to contact the Director of the School of Aquatic and Fishery Sciences.]
...
Each Thursday during lab, you will explore a dataset and prepare an analysis of the data using the techniques you learned in class that week. The lab write-up is due by 11:59 PM PDT on the Tuesday 10 days later. It will consist of SHORT write-ups of an analysis of the data with analysis and diagnostics. We will supply a template for the lab. You can work on the data as a group or solo. We will supply a data set, if you have a different data set that you or your group would like to use instead, you ask us if it will work. 

**Please refer to the [Lab Write-ups page](homework.html) for details and due dates.**

### Individual project (40%)  

Each student will have to write a complete, publishable (<20 page) paper that may, or may not, serve as a component of their thesis/dissertation. Given that some students might not have their own data, students may also use data from the instructors, public datasets or datasets included in __R__ libraries. See the [list of prior student projects](final_proj.html#student_pubs.html) for the types of projects completed in prior years.
...
**Please refer to the [Final Project page](final_proj.html) for details and due dates.**
...
You are welcome to use these tools (ChatGPT, Co-pilot, Claude, etc, etc) and they can be powerful coding assistants --- especially when you are not an expert in R, Stan or TMB etc. GitHub Copilot is an AI pair programmer, and is [free for students](https://github.com/education/students) (or you can get a 60 day trial). [chatGPT](https://openai.com/) and [Claude](https://claude.ai) free versions are good. You can describe what you want to do, paste in code and ask it to analyse, or describe tasks you want do with code or a described data set. If you use these for the lab text or paper text, please note this in your lab write-up so we can get a better understanding of how these tools help in the research process. [See this reddit thread](https://www.reddit.com/r/ChatGPTCoding/comments/1excgal/whats_the_best_ai_tool_to_help_with_coding/) for a semi-recent review of AI tools for coding; Claude seems to be a popular choice.

You can also use these tools to help you write better and faster and then go more indepth into your novel contributions. [Effortless Academic](https://effortlessacademic.com/a-complete-guide-to-using-ai-for-academic-writing/) has a lot of great, and realistic, content on using AI tools to assist literature reviews and analysis tailored to science academics. Do be cautious on what you get from AI tools though since they do (still) confidently make stuff up without careful promt engineering. I (Eli) have not found this in coding so much, but still run into this even with simple tasks in other contexts ("read this pdf and extract the descriptions of each river").
