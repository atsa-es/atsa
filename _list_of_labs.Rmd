...
arimalab <- fill.list(
  ...
  html = c("https://atsa-es.github.io/Labs/Week 2/Lab1-ARIMA-2023.html"),
  data = "See repo",
...
hmmlab <- fill.list(
  ...
  youtube = "",
  data = "",
  homework = "Lab write-up #4: HMM/Bayesian State space models. [Rmd](https://atsa-es.github.io/atsa/Labs/HW6/HW6.Rmd), [html](https://atsa-es.github.io/atsa/Labs/HW6/HW6.html), [Rmd Part 2 JAGS](https://atsa-es.github.io/atsa/Labs/HW6/HW6-part2-JAGS.Rmd), [Part 2 Online](https://rstudio.cloud/project/2228346)",
  key = "",
  instructor = "Eric",
  hw_topics = c(""),
