...
hmmlab <- fill.list(
  ...
  pdf = "",
  rmd = "",
  html = "https://atsa-es.github.io/atsa/Labs/Week%204/Lab4_hmm.html",
  video = "",
  youtube = "",
  data = "",
  homework = "Lab write-up #4: Hidden Markov Models. [Rmd](https://atsa-es.github.io/atsa/Labs/Week 4/Lab4_hmm.Rmd), [html](https://atsa-es.github.io/atsa/Labs/Week%204/Lab4_hmm.html)",
  key = "",
  instructor = "Eric",
  hw_topics = c(""),
